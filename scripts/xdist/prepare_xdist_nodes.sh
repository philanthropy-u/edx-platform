...
echo "pytest_worker_manager.py - EXITED"

echo "Need to map remote branch to local branch when fetching a branch other than master - STARTED"
...
echo "Need to map remote branch to local branch when fetching a branch other than master - ENDED"

echo "XDIST PREPARATION SCRIPT STARTED"
...
eval $cmd
echo "XDIST NODE CREATED AND PREPARED WITH TESTING.TXT INSTALLED"
