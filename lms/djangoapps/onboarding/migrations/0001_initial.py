    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unclaimed_org_admin_email', models.EmailField(max_length=254, null=True, db_index=True)),
                ...
                ('org_type', models.CharField(max_length=10, null=True)),
                ('level_of_operation', models.CharField(max_length=10, null=True)),
                ('focus_area', models.CharField(max_length=10, null=True)),
                ('total_employees', models.CharField(max_length=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.CharField(max_length=255, null=True)),
                ('city', models.CharField(max_length=255, null=True)),
                ('unclaimed_org_admin_email', models.EmailField(max_length=254, unique=True, null=True)),
                ('url', models.URLField(blank=True, max_length=255, null=True, validators=[lms.djangoapps.onboarding.models.SchemaOrNoSchemaURLValidator])),
                ('founding_year', models.PositiveSmallIntegerField(null=True, blank=True)),
                ('registration_number', models.CharField(max_length=30, null=True)),
                ('org_type', models.CharField(max_length=10, null=True)),
