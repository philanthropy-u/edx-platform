...
class Job(TimeStampedModel):
    ...
    description = models.TextField(verbose_name=_('Job Description'),
                                   help_text=_('Please share a brief description of the job.'))
    function = models.TextField(verbose_name=_('Job Function'),
    ...
    logo = models.ImageField(upload_to=UploadToPathAndRename('job-board/uploaded-logos/', 'logo'), blank=True,
