...
from openedx.features.partners.tests.factories import PartnerFactory


@ddt
class RegistrationViewTest(ApiTestCase):
    """
    Includes test cases for openedx partner feature for registration
    """
    ...
    def test_create_new_partner_user_with_organization(self):
        ...
        self.assertEqual(extended_profile.is_first_learner, False)
        self.assertHttpOK(response)
    ...
    def test_create_new_partner_user_with_new_organization(self):
        ...
        one and add user to it and mark him as a new learner.
        :return : None
        """
        response = self.client.post(self.registration_url, {
            "name": self.NAME,
        ...
        self.assertEqual(extended_profile.is_first_learner, True)
        self.assertHttpOK(response)
