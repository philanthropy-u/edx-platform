...
class UserBadge(models.Model):
    ...
    """
    user_id = models.ForeignKey(User, db_index=True, on_delete=models.CASCADE, db_column='user_id')
    badge_id = models.ForeignKey(Badge, on_delete=models.CASCADE, db_column='badge_id')
    ...
    def assign_badge(cls, user_id, badge_id, community_id):
        ...
        badge_id = Badge.objects.get(id=badge_id)
